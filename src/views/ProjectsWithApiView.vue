...
export default {
  data() {
    return {
      token: 'eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoiQURNSU4iLCJpZCI6MzMsImxvZ2luIjoiYXN0cmFsaWdodHYzQGdtYWlsLmNvbSIsInN1YiI6ImFzdHJhbGlnaHR2M0BnbWFpbC5jb20iLCJpYXQiOjE3Mjk0MzAxNTAsImV4cCI6MTcyOTU3NDE1MH0.ushwq7yqD2hhKEHmwaKRJdZS8qC7amHb0cL9sJe6yV4',
      projects: [
      ...
      <div class="row mt-3">
        ...
        <table class="table table-sm table-bordered">
          ...
          <tr>
            ...
            <td>
              {{ currentProject.number }} / {{ currentProject.project_name }} / {{ currentProject.description }}
            </td>
          </tr>
          <tr>
